...
fun onLoginClick(
    ...
    scope.launch {
        ...
        if(messagingSpaceInput === null) {
            ...
            msgSpace = client.api.room.createRoom(
            ...
            client.api.room.inviteUser(msgSpace, UserId(managerId)).getOrElse {
                client.api.room.leaveRoom(msgSpace)
                clientDir.deleteRecursively()
                abort(it.message ?: context.getString(R.string.generic_error))
                return@launch
            }
            ...
            client.api.room.joinRoom(msgSpace)
            val testRoom = client.api.room.createRoom(
                visibility = DirectoryVisibility.PRIVATE,
                name = "Test room",
                initialState = listOf(
        ...
        if (managementSpaceId !== null) {
            ...
            client.api.room.joinRoom(RoomId(managementSpaceId))
            client.api.room.sendStateEvent(
