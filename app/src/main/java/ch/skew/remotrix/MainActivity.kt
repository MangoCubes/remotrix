            ...
            navigation(route = Destination.Settings.route, startDestination = SettingsDest.Default.route) {
                composable(route = SettingsDest.Default.route) {
                    Settings(
                        ...
                        onSendSuccess.value ?: RemotrixSettings.OnSend.React,
                        onSendFailure.value ?: RemotrixSettings.OnSend.React,
                    )
                }
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            ListItem(
                headlineContent = { Text(stringResource(R.string.set_manager_account)) },
                supportingContent = { Text(stringResource(R.string.set_manager_account_desc)) },
                leadingContent = {
                    Icon(
            ...
            ListItem(
                ...
                supportingContent = { Text(stringResource(R.string.manage_accounts_desc)) },
                leadingContent = {
                    Icon(
