    ...
    scope.launch {
        try {
            ...
            if(matrixClient === null) {
                ...
                matrixClient.api.room.leaveRoom(RoomId(account.managementRoom))
                matrixClient.api.room.leaveRoom(RoomId(account.messageSpace))
                matrixClient.logout()
...
fun SessionItem(
    ...
    ListItem(
        headlineContent = { Text(account.fullName()) },
