...
fun DebugSettings(
    ...
    Scaffold(
        ...
        Column(
            ...
            ListItem(
                headlineContent = { Text(stringResource(R.string.receive_message_on_service_check)) },
                supportingContent = { Text(stringResource(R.string.receive_message_on_service_check_desc)) },
                leadingContent = {
                    Icon(
